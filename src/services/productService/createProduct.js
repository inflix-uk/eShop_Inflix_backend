    ...
    async processSingleProduct(productType_values, Seo_Meta, files, productUrl = 'default') {
        ...
        try {
            ...
            result.variantValuesArray.push({
                name: "single",
                Icon: null,
                Cost: parseFloat(productType_values.productCost) || null,
                Price: parseFloat(productType_values.productPrice) || null,
                salePrice: parseFloat(productType_values.productSalePrice) || null,
            ...
            for (const key in parsedVariantValues) {
                if (Object.hasOwnProperty.call(parsedVariantValues, key)) {
                    ...
                    result.variantValuesArray.push({
                        ...
                        Cost: parseFloat(variantValue.cost) || null,
                        Price: parseFloat(variantValue.price) || null,
